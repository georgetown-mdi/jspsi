...
export const UNCOVERED_VECTORS = [
  ...
  },
  {
    ...
    versionedBy:
      "the record document's own `psilink-exchange-record/v5` discriminant (docs/spec/EXCHANGE_RECORD.md). The record is written locally and never sent to the partner.",
  },
  {
