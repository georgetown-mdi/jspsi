...
- `CHANGELOG.md` is reader-facing release notes, not a commit log: pre-release, the default is no entry -- add one only for a major feature or a breaking change to something already listed. Full rule: `CONTRIBUTING.md`, Changelog.
