...
- Create a scratch directory with `mktemp -d`, never a fixed `/tmp` name: fixed names collide across agents, and a leftover symlink turns a scratch write into a repo write.
