...
- The web app runs recurring exchanges: either party can save an exchange as managed at invite creation or at accept (its terms and rotating secret persisted in the browser, origin-isolated), then run it again with the same partner without a new invitation. See `docs/MANAGED_EXCHANGE.md`.
