...
- Count-only (`psi-c`) exchanges are selectable and run end to end: both parties learn only the size of the intersection, subject to the agreed terms' output entitlement. See `docs/EXCHANGE_REFERENCE.md` and `docs/spec/PROTOCOL.md`.
