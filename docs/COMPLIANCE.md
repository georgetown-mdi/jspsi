...
| SC-8 | Transmission Confidentiality and Integrity | Data in transit is protected by AEAD ciphers derived from the SPAKE2 session key for SFTP and filedrop channels; WebRTC channels use DTLS end-to-end. |
