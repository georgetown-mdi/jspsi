...
Copy this into the connection block of your `alcove.yaml`:
...
Alcove enforces none of the following -- it constrains only what this side offers and accepts. These are the server-side settings to agree with your partner out of band, alongside the exchange directory and account access ([DEPLOYMENT.md](DEPLOYMENT.md#sftp-server)):
...
- [COMPLIANCE.md](COMPLIANCE.md#fips-140) - what Alcove does and does not claim about FIPS 140 validation
