...
This covers the npm tree this repository declares. The image as built -- its OS packages, and the npm CLI and Node binary its base bundles -- is gated separately, in CI, by the [image vulnerability scan](#image-vulnerability-scan).
