...
- **The browser-persisted managed-exchange record shape (persisted-vs-re-supplied fields, persist-before-success ordering, single-owner invariant)** -> [MANAGED_EXCHANGE_RECORD.md](MANAGED_EXCHANGE_RECORD.md).
