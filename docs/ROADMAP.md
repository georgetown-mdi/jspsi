...
- [Self-attested exchange record](EXCHANGE_RECORD.md): readable governance metadata so the local record stands alone as a disclosure-log entry (e.g. a HIPAA accounting of disclosures or a FERPA disclosure record), plus parity in the web application
...
- Signed exchange receipts: certificate-backed signing of a dual-signed exchange record, giving third-party-verifiable proof that a specific data set flowed between the two parties (deferred from the initial 1.0 scope)
