...
- Self-attested exchange record: readable governance metadata so the local record stands alone as a disclosure-log entry (e.g. a HIPAA accounting of disclosures or a FERPA disclosure record), plus parity in the web application
