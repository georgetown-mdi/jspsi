...
- **Cascade fan-out**, via extended per-round frames. It is the door this design leaves open rather than closes, and it inherits the resolution rule rather than choosing one.
