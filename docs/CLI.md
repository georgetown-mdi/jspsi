...
- Each linkage key: the elements it combines, the declared field behind each, every value transform with its parameters and what it does to matching, any approximate-match setting, and any swap.
