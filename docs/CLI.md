...
Each value anchors at most one certificate, so pinning the same fingerprint twice -- or pinning yourself -- anchors one slot and leaves the other for something else.
