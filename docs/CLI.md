...
The confirmation is unchanged: the terms are displayed and confirmed -- or recorded in advance with [`--consent-to-terms`](#accepting-without-the-prompt) -- before anything is written or dialed, and a decline writes no files and opens no connection.
