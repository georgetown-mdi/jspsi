...
- **Omit it for rules you author yourself.** There is no way to select a set other than the built-in one, and citing a set your rules were not drawn from misdescribes them. The web Advanced invite path drops the citation as soon as you edit your way out of the rules it seeded from.
