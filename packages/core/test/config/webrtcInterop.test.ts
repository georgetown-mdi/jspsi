 ...
 * apps/cli/test/unit/connection/webrtcInterop.test.ts,
 * apps/cli/test/unit/connection/webrtcDispatch.test.ts, and
 * apps/web/test/unit/psi/webrtcInterop.test.ts.
 */
